...
from losses.PriorCELoss import PriorCELoss

def get_loss_functions(configs, cls_num_list):
    losses = {}
    if configs.general.method == 'CNP':
        train_loss = nn.CrossEntropyLoss()
    elif configs.general.method == 'LOS':
        train_loss = nn.CrossEntropyLoss(label_smoothing=0.5)
    ...
    losses['val'] = nn.CrossEntropyLoss()
    losses['test'] = nn.CrossEntropyLoss()
    return losses
