...
def get_datasets(configs):
    ...
    if configs.general.dataset_name == 'nct':
        ...
        loader = 'others'
    datasets['train'] = customData(configs,img_path=configs.datasets.img_path,
                                ...
                                dataset='train',
                                twice = twice)
    datasets['val'] = customData(configs,img_path=configs.datasets.img_path,
                                np_path = configs.datasets.val.np_path,
                                dict_path=configs.datasets.val.dict_path,
                                loader=loader,
                                data_transforms=data_transforms,
                                dataset='val')
    datasets['test'] = customData(configs,img_path=configs.datasets.img_path,
